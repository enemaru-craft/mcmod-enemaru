...
import com.enemaru.blockentity.StationEndRodBlockEntity;
...
public class StationEndRodBlock extends BlockWithEntity {
    ...
    public StationEndRodBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(StationEndRodBlock::new);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new StationEndRodBlockEntity(pos, state);
    }

    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world.isClient) return null;
        return validateTicker(type, ModBlockEntities.STATION_END_ROD_ENTITY, StationEndRodBlockEntity::tick);
    }
